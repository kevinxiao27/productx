const mildKeywords = require('./mildKeywords');
const severeKeywords = require('./severeKeywords');
...
function mapSentimentToDanger(sentimentResults) {
...
module.exports = mapSentimentToDanger;
